...
# SCPN Theta-Pinch Core — transformations diagnostic tests
...
from scpn_theta_pinch_core.observability import TransformationKind
...
def test_transformation_rejects_self_mapping() -> None:
    ...
    with pytest.raises(DiagnosticPlanError, match="to itself"):
        frame_transformation(target_identifier="frm_coil_axis")
