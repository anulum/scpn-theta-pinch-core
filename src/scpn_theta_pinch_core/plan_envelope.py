...
# SCPN Theta-Pinch Core — portable diagnostic-plan envelope
...
PROJECT: Final = "SCPN-THETA-PINCH-CORE"
...
class PlanEnvelope:
    ...
    binding
        ...
        embedded :data:`~scpn_theta_pinch_core.observability.CATALOGUE_BINDING`.
    plan_identifier
